...
it('should create dynamically the progress bar according to the rank', () => {
  const wrapper = shallowMount(DaRadialProgress, { localVue, propsData: { steps: 3, progress: 0 } });
...
it('should add completed bars according to the progress', () => {
  const wrapper = shallowMount(DaRadialProgress, { localVue, propsData: { steps: 3, progress: 2 } });
